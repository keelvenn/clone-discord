import './css/footerfr.css'

const Footerfr = ({svg1, svg2, svg3, svg4, svg5, svg6, svg7}) => {
    return (
        <div>
            <footer className="footerfr"> 
                <div className='navfooter'>
                    
                    <div className='canal'>
                        <div className='canalinfo'>
                            <p style={{margin: '0px'}}> {svg1}Voz conectada</p>
                            <p style={{margin: '0px', fontSize: '11px'}}>Canal 1 - Pronome Neutro</p>
                        </div>
                            <div className='icons'>
                                <div className='logo'>{svg2}</div>
                                <div className='logo'>{svg3}</div>
                            </div>
                    </div>
                </div>

                <div className='icons2'>
                    <p className='screen'>{svg4} Vídeo</p>    
                    <p className='screen'>{svg4} Tela</p>
                </div>

                <div className='perfil'>
                    <div className='circ2'>
                        <div className='circ-mini'></div>
                    </div>

                    <div className='funcoes'>
                        <div className='tag'>
                            <p className='reset' style={{fontSize: '10px'}}>Nome</p>
                            <p className='reset' style={{fontSize: '10px'}}>#5432</p>
                        </div>

                        <div className='icons3'>
                            <div className='icons iconsf'>{svg5}</div>
                            <div className='icons iconsf'>{svg6}</div>
                            <div className='icons iconsf'>{svg7}</div>
                        </div>
                    </div>
